    ...
    <div>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        {currentProducts.map(product => (
          <div key={product.id} className="bg-white shadow-md rounded-lg flex flex-col items-center p-4 text-center">
            ...
            <div>
              ...
              <div className="flex"><a href='#' className='pr-2 text-blue-400 font-semibold'>{product.power}</a>
